    ...
    <section className="relative">
      ...
      >
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 h-full flex flex-col items-center justify-center text-center text-white">
          <h2 className="text-[96px] sm:text-[120px] md:text-[140px] leading-[0.85] font-extrabold drop-shadow-[0_6px_10px_rgba(0,0,0,0.6)]">
            10+ YEARS
          </h2>
          <h3 className="mt-2 text-3xl md:text-4xl font-bold tracking-wide drop-shadow-sm">
            SPORTS SHOES FACTORY
          </h3>

          <p className="mt-6 max-w-3xl text-gray-200 text-base md:text-lg">
